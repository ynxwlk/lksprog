...
class mt(models.Model):# 格式为ACCESS格式
	...
	syqsrq  =  models.DateField('使用起始日期')    #, max_length = 20,default='2018年1月1日', null=True, blank=True)  # 使用起始日期    日期/时间
	syzzrq  =  models.DateField('使用终止日期')    #, max_length = 20,default='2018年1月1日', null=True, blank=True)  # 使用终止日期    日期/时间
